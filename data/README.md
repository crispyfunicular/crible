...
| `canal` | texte | Ex. `discord#groupe-tal`, `whatsapp#promo` |
...
| `cascade_id` | texte | Identifiant de séquence (ex. `cascade_042`) si message en cascade — voir `docs/annotation_guide.md` § 3.4 |
...
| `emetteur_id` | texte | Pseudonyme stable anonymisé (pondération profil, § 8.2) |
